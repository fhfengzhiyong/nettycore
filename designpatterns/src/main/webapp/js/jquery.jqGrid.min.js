            ...
            if (!this.grid) {
                ...
                var
                    x, y = ["shiftKey", "altKey", "ctrlKey"], z = function (a, b) {
                        ...
                        for (var
                                 j = 0,
                                 k = t.length; k > j; j++)j > 0 && (d.p.sortname += ", "), d.p.sortname += t[j], j !== k - 1 && (d.p.sortname += " " + u[j]);
                        d.p.sortorder = u[k - 1]
            ...
            return d = a.extend(!0, {
                ...
                p() {
                    ...
                    if (s.p.multiselect && b[s.p.id].editselected) {
                        for (var
                                 f = [], g = 0,
                                 h = d.length; h > g; g++)-1 !== a.inArray(d[g], s.p.selarrrow) && f.push(d[g]);
                    ...
                    this.onchange = function () {
                        ...
                        if (void
                                0 !== b.rules)for (d = 0; d < b.rules.length; d++)if (g.append(this.createTableRowForRule(b.rules[d], b)), w)for (var
                                                                                                                                                      y = b.rules[d].field,
                                                                                                                                                      x = 0; x < f.p.columns.length; x++)if (y === f.p.columns[x].name) {
                ...
                if (!d.p.filterToolbar) {
                    ...
                    var
                        ...
                        j = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].base, k = function () {
                            ...
                            for (var
                                     g, j, l = a(".ui-jqgrid-view").css("font-size") || "11px",
                                     m = '<ul id="sopt_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="font-size:' + l + ";left:" + e + "px;top:" + f + 'px;">',
                                     n = a(c).attr("soper"), o = [], p = 0, q = a(c).attr("colname"),
                                     r = d.p.colModel.length; r > p && d.p.colModel[p].name !== q;)p++;
                            var
        ...
        setTreeNode: function (b, c) {
            ...
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid)switch (d.p.treeGridModel) {
                    ...
                    case"adjacency":
                        for (var
                                 k = d.p.treeReader.parent_id_field, l = d.p.localReader.id, m = b[l],
                                 n = d.p._index[m]; n--;)if (d.p.data[n][l] === a.jgrid.stripPref(d.p.idPrefix, b[k])) {
                            c = d.p.data[n];
                            break
                        }
                }
                ...
                if (c) {
                    ...
                    if (e = jqGridUtils.parse(c), e && "object" === a.type(e)) {
                        ...
                        if (e.treeGrid)for (var
                                                r = 1, s = n[0].rows.length, t = e.expColInd,
                                                u = e.treeReader.leaf_field,
                                                v = e.treeReader.expanded_field; s > r;)a(n[0].rows[r].cells[t]).find("div.treeclick").bind("click", function (b) {
                            var
                                c = b.target || b.srcElement,
