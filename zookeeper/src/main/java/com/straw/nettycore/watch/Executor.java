package com.straw.nettycore.watch;
...
public class Executor
        implements Watcher,  DataMonitor.DataMonitorListener {
    String znode;
    ...
    public static void main(String[] args) {
        ...
        String exec[] = new String[zargs.length - 3];
        System.arraycopy(zargs, 3, exec, 0, exec.length);
        try {
